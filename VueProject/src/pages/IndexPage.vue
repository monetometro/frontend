...
export default {
  props: {
    DTE: { type: String, default: new Date().toLocaleDateString() },
    DTI: { type: String, default: new Date().toLocaleDateString() },
    CMH: { type: String, default: "0" },
    ...
    updateMoney() {
      ...
      if (
        ...
        this.costsMsg.innerHTML =
          "<span style='font-size:100px;'>&#128546;</span></br>Verifique as configurações do evento!";
        this.showLine = true;
      }
